      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48 }}>
        ...
        <div>
          ...
          <Hoverable
            ...
            <div>
              <p style={{ fontSize: 11, color: 'var(--blue-400)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 2 }}>WhatsApp <span style={{ color: 'var(--blue-400)', fontStyle: 'italic', textTransform: 'none', letterSpacing: 0 }}>(solo messaggi)</span></p>
              <p style={{ color: 'var(--white)', fontWeight: 400 }}>+39 344 0729</p>
            </div>
          </Hoverable>
          <Hoverable
            as="a"
